...
2. [Запись студентов на курс](#1----)
3. [Запись студентов на курс](#2--)

---

# 1. Запись студентов на курс
...
[^1]: Использование материалов сайта без письменного разрешения авторов запрещено